...
public class Kruskal {
	public static void main(String[] args) {
		...
		Kruskal graph = new Kruskal();	//No error checking between nodeCount & graphEdges to see how many nodes actually exist
	...
	public void kruskalMST(ArrayList<Edge> graphEdges, int nodeCount){
		...
		try (PrintWriter outputFile = new PrintWriter( new File("outputMST.txt") ); ){
